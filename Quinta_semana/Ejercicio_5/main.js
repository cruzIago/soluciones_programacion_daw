...
/*
Función para actualizar el html cada vez que haya un cambio
*/
function __update_html__(perfil_usuario) {
    //let perfil_usuario = perfil_usuario;
    let nombre_1, apellidos_1, direccion_1, telefono_1, email_1; //Las variables que recogen la referencia del HTML

    //Esto es muy poco eficiente porque cada vez que haya un cambio tiene que recoger la referencia.
    //La forma de hacerlo lo veremos en el segundo trimestre, cuando hagamos programas mucho más complejos.
    nombre_1 = document.getElementById("nombre_1");
    apellidos_1 = document.getElementById("apellidos_1");
    ...
    nombre_1.innerHTML = "Nombre: " + perfil_usuario.getNombre();
    apellidos_1.innerHTML = "Apellidos: " + perfil_usuario.getApellidos();
    direccion_1.innerHTML = "Dirección: " + perfil_usuario.getDireccion();
    telefono_1.innerHTML = "Teléfono: " + perfil_usuario.getTelefono();
    email_1.innerHTML = "Email: " + perfil_usuario.getEmail();
}
...
function __update__(args) {
    ...
    do {
        ...
        __update_html__(perfil_usuario);
